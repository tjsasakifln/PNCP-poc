...
# ============================================================================
# User / Profile schemas (used by routes/user.py)
# ============================================================================
...
class DeleteAccountResponse(BaseModel):
    success: bool = True
    message: str = "Conta deletada com sucesso"


class PerfilContexto(BaseModel):
    porte_empresa: Optional[str] = None
    experiencia_licitacoes: Optional[str] = None
    ufs_atuacao: Optional[List[str]] = None
    setor_id: Optional[str] = None
    faixa_valor_min: Optional[float] = None
    faixa_valor_max: Optional[float] = None
    capacidade_funcionarios: Optional[str] = None
    faturamento_anual: Optional[str] = None
    atestados: Optional[bool] = None

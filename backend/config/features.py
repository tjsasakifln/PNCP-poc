...
_FEATURE_FLAG_REGISTRY: dict[str, tuple[str, str]] = {
    ...
    # --- Cache ---
    # Note: CACHE_WARMING_ENABLED, CACHE_REFRESH_ENABLED, CACHE_WARMING_POST_DEPLOY_ENABLED,
    # WARMUP_ENABLED removed 2026-04-18 (STORY-CIG-BE-cache-warming-deprecate).

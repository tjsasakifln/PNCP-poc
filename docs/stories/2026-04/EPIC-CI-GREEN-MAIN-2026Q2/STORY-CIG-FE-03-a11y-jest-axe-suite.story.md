...
- **2026-04-17** — @devops: Push + PR criado. PR #374: https://github.com/tjsasakifln/PNCP-poc/pull/374 — aguardando CI `frontend-tests.yml` (link do run a registrar aqui após verde).

...
- **2026-04-17** — @devops: branch `fix/cig-fe-05-14-15-licitacao-card-snapshot-drift` pushed; PR **#378** aberto (https://github.com/tjsasakifln/PNCP-poc/pull/378) cobrindo FE-05 + FE-14 + FE-15. Aguardando `frontend-tests.yml` run para marcar AC2 e transicionar para Done após merge.

...
- [ ] **AC1:** CTA pos-busca bem-sucedida em `SearchResults.tsx`:
...
- [ ] **AC2:** CTA pos-download Excel em `SearchResults.tsx`:
...
- [ ] **AC3:** CTA pos-adicionar ao pipeline em pipeline page:
...
- [ ] **AC4:** CTA na pagina de dashboard com metricas de uso:
...
- [ ] **AC5:** CTA em quota approaching (80%):
...
- [ ] **AC6:** Criar `frontend/components/billing/TrialUpsellCTA.tsx`:
...
- [ ] **AC7:** Frequencia max: 1 CTA por sessao de uso (nao bombardear)
...
- [ ] **AC8:** Manter `TrialConversionScreen.tsx` como modal de expiracao (nao duplicar)
- [ ] **AC9:** Manter `TrialExpiringBanner.tsx` como aviso de dias restantes (nao duplicar)
- [ ] **AC10:** CTAs contextuais complementam (nao substituem) os componentes existentes

### Analytics — Conversao por Ponto

- [ ] **AC11:** Dashboard admin deve mostrar (STORY-308):
...
- [ ] **AC12:** Testes para cada variant do TrialUpsellCTA (5 variants x render + dismiss + click)
- [ ] **AC13:** Teste de frequencia max (1 por sessao)
- [ ] **AC14:** Teste que CTA nao aparece para usuarios pagos

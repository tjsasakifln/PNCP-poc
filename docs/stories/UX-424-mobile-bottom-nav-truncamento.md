...
Bottom navigation bar mobile (375px) mostra labels truncados: "Hist." e "Dash" em vez de "Histórico" e "Dashboard". Seção de métricas na landing tem muito espaço em branco vertical. Carrossel de testimonials sem indicadores de swipe.

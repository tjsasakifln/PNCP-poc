...
def render_caddyfile(compiled: CompiledMap) -> str:
    """TLS terminator only. Never reverse_proxy to :8000/:3000."""
    lines = [
        ...
        "# Purpose: TLS + reverse_proxy to the local redirect process (serve.py).",
        "# Forbidden: product application upstreams and SaaS runtimes.",
        "# Cutover DNS/TLS remains BLOCKED until a named proxy+cert+rollback exist.",
        "",

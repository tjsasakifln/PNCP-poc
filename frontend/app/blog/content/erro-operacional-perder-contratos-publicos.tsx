  ...
  return (
    <>
      ...
      <div className="not-prose mt-8 sm:mt-12 bg-brand-blue-subtle dark:bg-brand-navy/20 rounded-xl p-5 sm:p-8 text-center border border-brand-blue/20">
        ...
        <Link
          href="/consultoria-b2g?source=blog&article=erro-operacional-perder-contratos-publicos&utm_source=blog&utm_medium=cta&utm_content=erro-operacional-perder-contratos-publicos&utm_campaign=b2g"

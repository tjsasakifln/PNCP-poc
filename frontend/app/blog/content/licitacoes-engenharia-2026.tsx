  ...
  return (
    <>
            ...
            mainEntity: [
              {
                ...
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'Para obras acima de R$ 3,3 milhões, a modalidade obrigatória é a concorrência (Lei 14.133/2021, art. 29, I). Para serviços de engenharia de menor complexidade e valores até R$ 3,3 milhões, o pregao eletrônico é a modalidade mais frequente, representando cerca de 60% dos processos no PNCP. O dialogo competitivo e usado em projetos de alta complexidade técnica onde a administração precisa discutir soluções antes de definir o objeto.',
                },
              },
              {
                '@type': 'Question',
                name: 'Quais documentos de habilitação técnica são obrigatorios?',
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'Os documentos obrigatorios incluem: atestados de capacidade técnica emitidos por órgãos públicos ou privados, Certidao de Acervo Tecnico (CAT) emitida pelo CREA ou CAU, registro da empresa no CREA/CAU da jurisdição, comprovação de equipe técnica mínima (vinculo via CTPS, contrato social ou contrato de prestação de serviços), e certidões negativas de débito (federal, estadual, municipal, FGTS, trabalhista).',
                },
              },
              {
                '@type': 'Question',
              ...
              },
              {
                ...
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'Os prazos variam por modalidade: concorrência tem prazo mínimo de 35 dias úteis entre publicação e abertura (Lei 14.133, art. 55, I); pregao eletrônico tem prazo mínimo de 8 dias úteis. O período de esclarecimentos encerra normalmente 3 dias úteis antes da abertura. Após a adjudicação, a assinatura do contrato ocorre em até 60 dias, é a ordem de serviço e emitida em até 30 dias após a assinatura. O ciclo completo — da publicação do edital ao início efetivo da obra — leva tipicamente de 90 a 180 dias.',
                },
              },
              {
                '@type': 'Question',
          ...
          __html: JSON.stringify({
            ...
            step: [
              ...
              },
              {
                ...
                text: 'Reuna atestados de capacidade técnica e registre as Certidoes de Acervo Tecnico (CAT) no CREA. Priorize atestados que cubram as parcelas de maior relevância exigidas em editais.',
              },
              {
                '@type': 'HowToStep',
                name: 'Manter certidões atualizadas',
                text: 'Mantenha em dia: CND federal (Receita + PGFN), certidão estadual, municipal, FGTS (CRF), certidão trabalhista (CNDT) e balanco patrimonial do ultimo exercício.',
              },
              {
                '@type': 'HowToStep',
                name: 'Identificar e analisar editais',
                text: 'Monitore o PNCP e portais estaduais diariamente. Análise cada edital verificando: modalidade, valor estimado, prazo, exigências de habilitação e local de execução.',
              },
              {
                '@type': 'HowToStep',
              ...
              },
              {
                ...
                text: 'Na data de abertura, envie a documentação de habilitação e proposta. Em pregões, participe da fase de lances com estrategia de preços previamente definida.',
              },
              {
                '@type': 'HowToStep',
      ...
      <p className="text-base sm:text-xl leading-relaxed text-ink">
        ...
        bilhões. Com o avanço do Novo PAC é os investimentos em infraestrutura
        ...
        valor, requisitos de habilitação, erros frequentes e estrategia de
        priorização.
      </p>
      ...
      <p>
        ...
        nos tres níveis federativos -- federal, estadual e municipal.
      </p>
      ...
      <p>
        ...
        significa que o mercado não esta concentrado apenas em grandes obras
      ...
      <div className="not-prose my-6 sm:my-8 bg-surface-1 border border-[var(--border)] rounded-lg p-4 sm:p-6">
        <p className="text-sm font-semibold text-ink mb-3">
          Numeros do setor -- Engenharia e Construção em licitações (2025)
        </p>
        <ul className="space-y-2 text-sm text-ink-secondary">
          ...
          <li>
            ...
            acima de R$ 3,3M; pregao eletrônico para serviços de engenharia
          </li>
          <li>
      ...
      <p>
        ...
        todos os órgãos federais é a maioria dos estaduais são obrigados a
      ...
      <p>
        ...
        aplicáveis a obras e serviços de engenharia. Compreender cada uma e
      ...
      <p>
        ...
        (art. 6o, XIII, Lei 14.133). Na prática, isso inclui serviços de
      ...
      <p>
        ...
        a solução sem dialogo previo. Embora ainda pouco frequente em
      ...
      <p>
        ...
        modalidade, mas também o perfil de concorrência é os requisitos de
      ...
      <div className="not-prose my-6 sm:my-8 bg-surface-1 border border-[var(--border)] rounded-lg p-4 sm:p-6">
        ...
        <ul className="space-y-2 text-sm text-ink-secondary">
          <li>
            ...
            Pavimentação de ruas, reformas de predios públicos, construção de
            calcadas e praças. Maior volume de editais, menor concorrência por
      ...
      <p>
        A recomendação estratégica e que empresas identifiquem a faixa onde
        ...
        editais de R$ 30 milhões que exigem atestados fora do seu portfolio --
      ...
      <div className="not-prose my-6 sm:my-8 bg-surface-1 border border-[var(--border)] rounded-lg p-4 sm:p-6">
        ...
        <ul className="space-y-2 text-sm text-ink-secondary">
          ...
          <li>
            ...
            Concentrado na região metropolitana e Niteroi. Grandes obras de
          ...
          <li>
            ...
            Municipios de médio porte com boa capacidade de contratação.
          </li>
          <li>
      ...
      <p>
        Para empresas com atuação regional, a estrategia mais eficiente e
      ...
      <p>
        ...
        ou equipe técnica sem vinculo comprovado.
      </p>
      ...
      <p>
        ...
        relevante (art. 67, §1o). Atestados de obras privadas são aceitos,
      ...
      <p>
        A CAT e emitida pelo CREA ou CAU e vincula a responsabilidade técnica
        de um profissional a uma obra ou serviço específico. E o documento que
      ...
      <p>
        ...
        (socio), ou contrato de prestação de serviços com cláusula de
      ...
      <h3>Certidoes e qualificação econômico-financeira</h3>

      <p>
        Além dos documentos técnicos, a habilitação exige: CND federal
        (Receita + PGFN), CRF do FGTS, CNDT (certidão trabalhista), certidões
        estadual e municipal, balanco patrimonial do ultimo exercício social,
        e índices contabeis (liquidez geral, liquidez corrente, solvência
      ...
      <p>
        ...
        tributário da empresa impacta diretamente a composição. O Acordao
      ...
      <p>
        ...
        fatores que impactam diretamente o custo é que não estao
      ...
      <p>
        ...
        do edital é a data de abertura. A prática recomendada e manter um
      ...
      <p>
        ...
        técnica e preço, empresas com acervo técnico diferenciado tem
        vantagem. Em pregões de menor preço, a competição e acirrada é a
      ...
      <p>
        ...
        em concorrência e 35 dias úteis, mas propostas de qualidade exigem
        ...
        da empresa -- uma construtora com tres obras em andamento pode não
      ...
      <p>
        ...
        e se os quantitativos estao compatíveis com o projeto básico. Editais
      ...
      <p>
        ...
        remotas, o acrescimo logístico deve ser calculado antes da decisão
        de participar.
      </p>
      ...
      <p>
        Esse modelo de avaliação permite comparar multiplos editais
      ...
      <p>
        ...
        em outros setores, devido a complexidade técnica e aos requisitos
      ...
      <div className="not-prose my-6 sm:my-8 bg-surface-1 border border-[var(--border)] rounded-lg p-4 sm:p-6">
        ...
        <ul className="space-y-2 text-sm text-ink-secondary">
          ...
          <li>
            <strong>Dias 1-25:</strong> Periodo para análise do edital,
          ...
          <li>
            ...
            respostas da comissao. Eventuais impugnações ao edital devem ser
          ...
          <li>
            ...
            pela comissao em sessao pública.
          </li>
          <li>
            <strong>Dias 35-65:</strong> Análise das propostas pela comissao,
          ...
          <li>
            ...
            de garantia contratual e seguro, emissao da ordem de serviço.
          </li>
          <li>
      ...
      <p>
        ...
        simultâneos para garantir fluxo continuo de contratos. Para aprender
      ...
      <p>
        ...
        que atuam na interseção entre engenharia e tecnologia tem acesso a um
      ...
      <div className="not-prose mt-8 sm:mt-12 bg-brand-blue-subtle dark:bg-brand-navy/20 rounded-xl p-5 sm:p-8 text-center border border-brand-blue/20">
        <p className="text-lg sm:text-xl font-bold text-ink mb-2">
          Monitore editais de engenharia com inteligência -- 14 dias gratis
        </p>
      ...
      <p>
        ...
        complexidade e valores até R$ 3,3 milhões, o pregao eletrônico é a
        ...
        julgamento é o perfil de concorrentes.
      </p>

      <h3>Quais documentos de habilitação técnica são obrigatorios?</h3>
      <p>
        ...
        da jurisdição, comprovação de equipe técnica mínima com vinculo
        ...
        exigem balanco patrimonial e índices contabeis que comprovem capacidade
      ...
      <p>
        ...
        diarias), certidões e documentação de habilitação, e garantia de
      ...
      <p>
        ...
        (Beneficios e Despesas Indiretas) é o percentual adicionado ao custo
        direto da obra para cobrir despesas indiretas, tributos e lucro. O
        Acordao 2.622/2013 do TCU estabelece faixas de referência: para
      ...
      <p>
        ...
        pregao eletrônico tem prazo mínimo de 8 dias úteis. O período de

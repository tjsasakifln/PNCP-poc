  ...
  return (
    <>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                '@type': 'Question',
                name: 'Como chegaram ao número de 40 horas por mes?',
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'O cálculo considera uma empresa que monitora 3 fontes de dados (PNCP, Portal de Compras Públicas, ComprasGov), analisa em média 25 editais por dia útil (5 minutos de leitura inicial cada) e descarta 80% após a primeira análise. São aproximadamente 500 editais por mes, 5 minutos cada, totalizando 2.500 minutos ou 41,7 horas. Empresas com mais UFs monitoradas ou mais setores de atuação frequentemente ultrapassam esse número.',
                },
              },
              {
                '@type': 'Question',
                name: 'E possível reduzir esse tempo sem perder oportunidades relevantes?',
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'Sim. A triagem em 3 camadas (filtro automático por setor e região, avaliação de viabilidade por critérios objetivos, e análise detalhada apenas dos pre-qualificados) reduz o tempo de triagem em 60% a 75% sem aumento na taxa de oportunidades perdidas. O ganho vem da eliminação de editais irrelevantes antes que um analista humano precise le-los.',
                },
              },
              {
                '@type': 'Question',
                ...
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'Considerando o custo médio de um analista de licitações (salário + encargos de R$ 7.500/mes para 176 horas), 40 horas representam R$ 1.704 em custo direto. Somando custo de oportunidade (propostas não elaboradas), o impacto anual pode chegar a R$ 120 mil a R$ 200 mil para empresas de médio porte.',
                },
              },
              {
                '@type': 'Question',
                ...
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'Não substituem, mas reposicionam. A automação assume a camada de triagem inicial (filtro setorial, geográfico é de valor), liberando o analista para a camada que exige julgamento humano: análise técnica do edital, avaliação de competitividade e decisão estratégica de participação. O resultado é um analista que trabalha em 15 editais qualificados por semana em vez de 125 editais brutos.',
                },
              },
              {
                '@type': 'Question',
                ...
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'Os resultados em redução de tempo são imediatos (primeira semana). A melhoria na taxa de conversão de propostas leva de 2 a 3 meses para se materializar nas métricas, porque o ciclo de licitação (da publicação a adjudicação) leva em média 30 a 60 dias.',
                },
              },
            ],
          }),
      ...
      <p className="text-base sm:text-xl leading-relaxed text-ink">
        Quarenta horas por mes. Esse é o tempo médio que equipes de licitação
        ...
        não vao gerar proposta, não vao gerar contrato e não vao gerar
      ...
      <h2>O número: como chegamos em 40 horas por mes</h2>
      ...
      <p>
        ...
        dados consolidados dez/2025). Distribuidas pelos 220 dias úteis do
      ...
      <p>
        ...
        de leitura inicial cada, são 125 minutos diarios. Em 20 dias úteis,
        isso totaliza 2.500 minutos, ou 41,7 horas.
      </p>

      <p>
        Desses 25 editais diarios, entre 18 e 22 serao descartados após a
        ...
        editais descartados e puro desperdício operacional.
      </p>
      ...
      <p>
        A primeira causa do desperdício e estrutural: a maioria das empresas
      ...
      <p>
        ...
        quando os termos do setor são ambiguos. &ldquo;Manutenção predial&rdquo;
        ...
        inclusao mas também termos de exclusao, o volume de resultados
      ...
      <p>
        A segunda causa e processual: a equipe não tem critérios predefinidos
      ...
      <p>
        ...
        e atendível, e (4) o prazo de abertura permite preparação adequada.
      ...
      <p>
        A terceira causa e comportamental. Equipes de licitação operam sob
        pressao constante por resultados, é o medo de descartar uma
      ...
      <p>
        O antidoto para o FOMO e dados. Quando a equipe tem métricas claras
        ...
        Gastar tempo neles não é diligência; e desperdício disfarçado de
      ...
      <p>
        A quarta causa e tecnológica. A maioria das empresas monitora
        multiplas fontes simultaneamente: PNCP, Portal de Compras Públicas,
      ...
      <p>
        ...
        real, é necessário considerar tres componentes.
      </p>
      ...
      <div className="not-prose my-6 sm:my-8 bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4 sm:p-6">
        ...
        <p className="text-sm text-ink-secondary mb-3">
          ...
          dedicado, salário + encargos de R$ 7.500/mes (176 horas úteis/mes).
        </p>
        <ul className="space-y-2 text-sm text-ink-secondary">
          <li>• <strong>Custo direto (salário proporcional):</strong> 40h / 176h x R$ 7.500 = R$ 1.704/mes = R$ 20.454/ano</li>
          <li>• <strong>Custo de oportunidade (propostas não elaboradas):</strong> Se cada proposta não elaborada tem valor médio de R$ 200 mil e taxa de conversão de 20%, cada proposta perdida custa R$ 40 mil em receita esperada. As 40 horas desperdicadas poderiam gerar 2-3 propostas adicionais por mes.</li>
        ...
        <p className="text-sm text-ink-secondary mt-3">
          ...
          mais de R$ 400 mil por ano em custos diretos é de oportunidade
          combinados.
        </p>
      </div>
      ...
      <p>
        ...
        dos editais realmente relevantes, é o impacto na moral de uma equipe
      ...
      <p>
        ...
        estruturação do processo em tres camadas, onde cada camada elimina
        editais irrelevantes antes que a próxima camada invista tempo neles.
      </p>

      <h3>Camada 1: Filtro automático (maquina)</h3>

      <p>
        A primeira camada e inteiramente automatizada: busca consolidada em
        multiplas fontes com filtro por setor (keywords + exclusões), região
      ...
      <p>
        ...
        pre-filtrada que já eliminou a maioria dos editais irrelevantes.
      </p>
      ...
      <p>
        ...
        é as margens da empresa, e viabilidade logística/geográfica.
      </p>

      <p>
        Essa avaliação pode ser semi-automatizada: o sistema aplica os
        critérios e apresenta uma pontuação de viabilidade, é o analista
      ...
      <p>
        ...
        a análise detalhada humana. Nessa camada, o analista le o edital
      ...
      <div className="not-prose my-6 sm:my-8 bg-surface-1 border border-[var(--border)] rounded-lg p-4 sm:p-6">
        ...
        <ul className="space-y-2 text-sm text-ink-secondary">
          ...
          <li>• <strong>Triagem em 3 camadas:</strong> Camada 1 elimina 350 (automático, 0 min humano). Camada 2 elimina 90 dos 150 restantes (2 min cada, 3h). Camada 3 analisa 60 qualificados (5 min cada, 5h). Total: 8h/mes</li>
          <li>• <strong>Economia:</strong> 32 horas/mes = 384 horas/ano = quase 50 dias úteis devolvidos a equipe</li>
        </ul>
      </div>
      ...
      <p>
        ...
        tempo e redirecionado para atividades de maior valor: elaboração
      ...
      <h3>Como chegaram ao número de 40 horas por mes?</h3>
      <p>
        ...
        a primeira análise. São aproximadamente 500 editais por mes, 5 minutos
      ...
      <h3>E possível reduzir esse tempo sem perder oportunidades relevantes?</h3>
      <p>
        ...
        precise le-los, não da redução na análise dos editais qualificados.
      </p>

      <h3>Qual o custo real dessas 40 horas perdidas por mes?</h3>
      <p>
        Considerando o custo médio de um analista de licitações (salário +
        encargos de R$ 7.500/mes para 176 horas úteis), 40 horas representam
      ...
      <p>
        ...
        triagem inicial (filtro setorial, geográfico é de valor), que é
        repetitiva e baseada em critérios objetivos. O analista humano e
      ...
      <p>
        ...
        completo de licitação (da publicação do edital a adjudicação) leva em

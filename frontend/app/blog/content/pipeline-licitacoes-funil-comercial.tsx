  ...
  return (
    <>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                '@type': 'Question',
                name: 'Qual a diferença entre um pipeline de licitações e um CRM tradicional?',
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'O pipeline de licitações segue etapas reguladas por lei (publicação, habilitação, julgamento, adjudicação), com prazos definidos em edital e critérios objetivos de avaliação. Diferentemente do CRM B2B, não há negociação direta com o comprador, e o processo decisório é transparente e auditável. A ferramenta precisa refletir essas particularidades.',
                },
              },
              {
                '@type': 'Question',
                ...
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'Depende da capacidade operacional da equipe. Uma regra prática é manter entre 3x e 5x o número de contratos que a empresa deseja fechar por trimestre. Se a meta é 4 contratos no trimestre e a taxa de conversão histórica é 20%, o pipeline deve conter pelo menos 20 oportunidades ativas distribuídas entre as etapas.',
                },
              },
              {
                '@type': 'Question',
                name: 'É possível implementar um pipeline de licitações em planilha?',
                acceptedAnswer: {
                  '@type': 'Answer',
      ...
      <p>
        ...
        adjudicação significativamente superiores às que operam de forma reativa.
      ...
      <p>
        ...
        idênticas às de um CRM B2B, mas a lógica é a mesma: cada oportunidade
        avança por estágios com critérios claros de progressão e descarte.
      </p>
      ...
      <p>
        ...
        publicações relevantes por semana. O papel da prospecção é alimentar o
      ...
      <p>
        ...
        capturada na prospecção é avaliada contra critérios objetivos de
      ...
      <p>
        O objetivo da triagem é eliminar rapidamente as oportunidades
      ...
      <p>
        As oportunidades que sobrevivem à triagem entram na fase de análise
        detalhada. Aqui, a equipe lê o edital completo, verifica requisitos de
      ...
      <p>
        ...
        que chega à análise sem merecimento consome recursos que poderiam ser
      ...
      <p>
        Com a análise positiva, a equipe elabora a proposta comercial e reúne a
        ...
        envio. O prazo entre a decisão de participar e a data de abertura é
        frequentemente curto, o que exige processos internos ágeis.
      </p>

      <p>
        Empresas com pipeline estruturado mantêm documentação-base atualizada
        permanentemente (certidões, atestados, balanços), reduzindo o tempo de
      ...
      <p>
        ...
        Isso inclui monitorar a sessão pública, responder a diligências,
        acompanhar recursos e impugnações, e validar o resultado da
        adjudicação. O acompanhamento não termina na adjudicação: a
        homologação, a assinatura do contrato e o primeiro faturamento
        completam o ciclo.
      </p>

      <p>
        Um erro comum é abandonar o acompanhamento após a adjudicação. Contratos
        podem ser anulados, recursos podem reverter resultados, e atrasos na
        homologação podem afetar o planejamento financeiro. O pipeline só
        considera a oportunidade concluída quando há contrato assinado.
      </p>

      <h2>Métricas de cada etapa</h2>
      ...
      <p>
        ...
        identificar gargalos. As métricas essenciais são três: taxa de
        conversão entre etapas, tempo médio de permanência em cada estágio e
      ...
      <div className="not-prose my-6 sm:my-8 bg-surface-1 border border-[var(--border)] rounded-lg p-4 sm:p-6">
        ...
        <ul className="space-y-2 text-sm text-ink-secondary">
          <li>• <strong>Prospecção para Triagem:</strong> 100% (toda oportunidade capturada é triada)</li>
          ...
          <li>• <strong>Conversão total (Prospecção a Adjudicação):</strong> 3% a 8% é normal; acima de 15% indica processo maduro</li>
        </ul>
      </div>
      ...
      <p>
        Quantidade de oportunidades ativas no pipeline, distribuídas por etapa.
      ...
      <p>
        Tempo médio do ciclo completo (da prospecção à adjudicação) e tempo
        ...
        conseguem identificar rapidamente quando uma oportunidade está
      ...
      <div className="not-prose my-6 sm:my-8 bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4 sm:p-6">
        ...
        <ul className="space-y-2 text-sm text-ink-secondary">
          <li>• <strong>Prospecção:</strong> 120 editais capturados por mês (monitoramento de 12 UFs)</li>
          ...
          <li>• <strong>Adjudicação:</strong> 3 contratos fechados por mês (25% das propostas)</li>
        </ul>
        <p className="text-sm text-ink-secondary mt-3">
          Conversão total: 2,5% (3/120). Valor médio por contrato: R$ 220 mil.
          Receita mensal: R$ 660 mil. O pipeline permite prever que, mantendo o
          volume de prospecção e as taxas de conversão, o faturamento anual
          será de aproximadamente R$ 7,9 milhões. Qualquer desvio nas métricas
          intermediárias acende um alerta antes que o impacto chegue ao
          faturamento.
        </p>
      </div>
      ...
      <p>
        A pergunta mais comum ao implementar um pipeline de licitações é qual
        ferramenta usar. A resposta depende do estágio da empresa e do volume
      ...
      <p>
        ...
        que a oportunidade seja movida da prospecção à triagem com dados de
        viabilidade já preenchidos.
      </p>

      <p>
        A transição de planilha para sistema dedicado deve acontecer quando a
        equipe percebe que está perdendo prazos, duplicando análises ou não
        consegue responder rapidamente à pergunta: &ldquo;quantas oportunidades
      ...
      <p>
        Reúna a equipe e defina as etapas do pipeline (as cinco descritas
        anteriormente servem como modelo-base). Para cada etapa, estabeleça os
        critérios de avanço e os critérios de descarte. Documente em uma página.
        Não complique: a primeira versão será ajustada com o uso.
      </p>
      ...
      <p>
        ...
        etapas e campos obrigatórios. Se usar planilha, crie um modelo-padrão
      ...
      <p>
        ...
        critérios conforme a realidade: se a triagem está descartando
        oportunidades que deveriam avançar (ou aprovando as que deveriam ser
        descartadas), recalibre os parâmetros.
      </p>

      <h3>Semana 4: Métricas e rotina</h3>

      <p>
        Estabeleça a rotina de atualização do pipeline. Uma reunião semanal de
        15 minutos para revisar o funil é suficiente. Defina quem é responsável
        por cada etapa. Comece a medir as taxas de conversão e os tempos de
        permanência. Após 30 dias, você terá dados suficientes para o primeiro
        ajuste estruturado.
      </p>
      ...
      <p>
        ...
        sua eficácia. Os mais frequentes são:
      </p>

      <p>
        <strong>Não descartar oportunidades.</strong> O medo de perder uma
        licitação leva equipes a manter oportunidades inviáveis no pipeline,
        inflando artificialmente o volume e distorcendo as métricas. Um pipeline
        eficiente descarta ativamente. Se uma oportunidade não atende aos
        critérios de triagem, ela deve sair do funil.
      </p>

      <p>
        <strong>Não atualizar o status.</strong> Um pipeline desatualizado é
        pior do que não ter pipeline, porque gera falsa confiança. A
        atualização deve ser diária ou, no mínimo, a cada movimentação
        relevante (avançar etapa, descartar, receber resultado).
      </p>
      ...
      <p>
        ...
        rentáveis, quais modalidades têm melhor conversão. Ignorar esses dados é
        desperdiçar o principal ativo do pipeline.
      </p>

      <h2>Do pipeline à previsibilidade de receita</h2>

      <p>
        O benefício final de um pipeline bem gerenciado não é organização: é
      ...
      <div className="not-prose mt-8 sm:mt-12 bg-brand-blue-subtle dark:bg-brand-navy/20 rounded-xl p-5 sm:p-8 text-center border border-brand-blue/20">
        ...
        <p className="text-sm sm:text-base text-ink-secondary mb-4 sm:mb-6 max-w-lg mx-auto">
          Gerencie oportunidades da prospecção à adjudicação com visão kanban,
          alertas de prazo e métricas automáticas. Integrado com busca
          multi-fonte e classificação por IA.
        </p>
        <Link
          href="/consultoria-b2g?source=blog&article=pipeline-licitações-funil-comercial&utm_source=blog&utm_medium=cta&utm_content=pipeline-licitações-funil-comercial&utm_campaign=b2g"
      ...
      <h3>Qual a diferença entre um pipeline de licitações e um CRM tradicional?</h3>
      <p>
        ...
        negociação direta com o comprador, e o processo decisório é
      ...
      <p>
        Depende da capacidade operacional da equipe. Uma regra prática é manter
        entre 3x e 5x o número de contratos que a empresa deseja fechar por
        trimestre. Se a meta é 4 contratos no trimestre e a taxa de conversão
        histórica é 20%, o pipeline deve conter pelo menos 20 oportunidades
        ativas distribuídas entre as etapas.
      </p>

      <h3>É possível implementar um pipeline de licitações em planilha?</h3>
      <p>
        ...
        dados e a necessidade de atualização manual constante tornam a planilha
        um gargalo operacional. A transição para um sistema dedicado deve
        ocorrer quando a equipe percebe que está perdendo prazos ou duplicando
        esforços.
      </p>
      ...
      <p>
        ...
        taxas entre 20% e 35%. A diferença está primariamente na qualidade da

...
export default function PerfilPage() {
  ...
  const { profileCtx, isLoading: profileLoading, updateCache, error: profileError } = useProfileContext();
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-6 bg-[var(--surface-0)] border border-[var(--border)] rounded-card" data-testid="profile-licitante-section">
        ...
        {/* UX-429 AC3: Estado de erro amigável quando fetch de rede falha */}
        {!profileLoading && profileCtx === null && profileError && (
          <div
            className="flex items-start gap-3 p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg"
            data-testid="profile-context-error"
            role="alert"
          >
            ...
            <div>
              <p className="text-sm font-medium text-red-800 dark:text-red-300">
                Não foi possível carregar o perfil de licitante.
              </p>

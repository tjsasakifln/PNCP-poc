...
export default function TrustCriteria({ className = '' }: TrustCriteriaProps) {
  ...
  return (
    ...
    >
      {/* AC1 — Header: "Cada recomendação tem uma justificativa" */}
      <div
      ...
      <div
        className={`grid sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-16 transition-all duration-500 delay-100 ${
          isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
        }`}
      >
      ...
      <div
        className={`bg-surface-1 border border-[var(--border)] rounded-2xl p-8 mb-16 transition-all duration-500 delay-200 ${
          isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
        }`}
      >
      ...
      <div
        className={`grid md:grid-cols-2 gap-6 transition-all duration-500 delay-300 ${
          isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
        }`}
      >

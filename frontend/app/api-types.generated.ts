...
export interface paths {
    ...
    "/api/email/click/{tracking_id}": {
         ...
         */
        get: operations["track_email_click_api_email_click__tracking_id__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/email/open/{tracking_id}": {
         ...
         */
        get: operations["track_email_open_api_email_open__tracking_id__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/email/track-sent": {
         ...
         */
        post: operations["track_digest_sent_api_email_track_sent_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/email/unsubscribe": {
         ...
         */
        post: operations["track_email_unsubscribe_api_email_unsubscribe_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/admin/metrics/digest": {
         ...
         *     returns zeros.
         */
        get: operations["get_digest_metrics_v1_admin_metrics_digest_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/v1/csp-report": {
         ...
         */
        post: operations["csp_report_v1_v1_csp_report_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/workspace/centro-guerra/{edital_id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Get Centro Guerra
         * @description Full 360-degree view of a procurement opportunity.
         *
         ...
         */
        get: operations["get_centro_guerra_v1_workspace_centro_guerra__edital_id__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/workspace/centro-guerra/{edital_id}/proximos-passos": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /**
         * Update Proximos Passos
         * @description Update/customize the next steps for a bid.
         *
         *     This is an in-memory operation for the reduced scope — no DB persistence.
         *     Simply echoes back the provided passos.
         */
        post: operations["update_proximos_passos_v1_workspace_centro_guerra__edital_id__proximos_passos_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    schemas: {
        ...
        AdminDigestMetricsResponse: {
            ...
            breakdown_by_frequency: {
                [key: string]: components["schemas"]["DigestFrequencyBreakdown"];
            };
            /**
             * Click Rate 30D
             * @default 0
            ...
            /**
             * Total Unsubscribed 30D
             * @default 0
             */
            total_unsubscribed_30d: number;
            /**
         ...
         * @description A competitor supplier that has contracts with the same orgao.
         */
        CentroGuerraConcorrente: {
            /**
             * Cnpj
         ...
         * @description Response after updating/customizing next steps.
         */
        CentroGuerraPassosResponse: {
            /** Edital Id */
            edital_id: string;
         ...
         * @description User customization of next steps for a bid.
         */
        CentroGuerraProximoPassoRequest: {
            /** Passos */
            passos: string[];
         ...
         * @description Consolidated view of a single procurement opportunity.
         */
        CentroGuerraResponse: {
            /**
             * Concorrentes
             * @default []
             */
            concorrentes: components["schemas"]["CentroGuerraConcorrente"][];
            /** Data Abertura */
            data_abertura?: string | null;
            /** Data Publicacao */
        ...
        DbPoolStatusResponse: {
            ...
            status: string;
            /**
             * Threshold Critical Pct
             * @default 85
             */
            threshold_critical_pct: number;
            /**
             * Threshold Warning Pct
             * @default 80
             */
...
export interface operations {
    ...
    track_email_click_api_email_click__tracking_id__get: {
        parameters: {
            query: {
    ...
    track_email_open_api_email_open__tracking_id__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    track_digest_sent_api_email_track_sent_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["TrackSentRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["TrackSentResponse"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    track_email_unsubscribe_api_email_unsubscribe_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    get_db_pool_status_v1_admin_db_pool_get: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["DbPoolStatusResponse"];
                };
            };
        };
    };
    ...
    get_digest_metrics_v1_admin_metrics_digest_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["AdminDigestMetricsResponse"];
                };
            };
        };
    };
    ...
    csp_report_v1_v1_csp_report_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    get_centro_guerra_v1_workspace_centro_guerra__edital_id__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["CentroGuerraResponse"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    update_proximos_passos_v1_workspace_centro_guerra__edital_id__proximos_passos_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CentroGuerraProximoPassoRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["CentroGuerraPassosResponse"];
                };
            };
            /** @description Validation Error */
            422: {

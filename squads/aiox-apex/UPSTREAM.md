...
- Resync é operação consciente: `git clone https://github.com/SynkraAI/aiox-squads.git /tmp/aiox-sync && rsync -a /tmp/aiox-sync/squads/apex/ /mnt/d/pncp-poc/squads/aiox-apex/ --exclude='config/smartlic-overlay.yaml' --exclude='*.smartlic.md' --exclude='UPSTREAM.md'`
...
- `examples/` (68K) — exemplos não essenciais

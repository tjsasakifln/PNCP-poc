...
- Resync é operação consciente: `git clone https://github.com/SynkraAI/aiox-squads.git /tmp/aiox-sync && rsync -a /tmp/aiox-sync/squads/legal-analyst/ /mnt/d/pncp-poc/squads/aiox-legal-analyst/ --exclude='config/smartlic-overlay.yaml' --exclude='*.smartlic.md' --exclude='UPSTREAM.md'`
...
- `webapp/` (380K) — app deploy Hostinger, irrelevante para uso como agente

...
- Resync é operação consciente: `git clone https://github.com/SynkraAI/aiox-squads.git /tmp/aiox-sync && rsync -a /tmp/aiox-sync/squads/dispatch/ /mnt/d/pncp-poc/squads/aiox-dispatch/ --exclude='config/smartlic-overlay.yaml' --exclude='*.smartlic.md' --exclude='UPSTREAM.md'`

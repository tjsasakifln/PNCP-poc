...
- Resync é operação consciente: `git clone https://github.com/SynkraAI/aiox-squads.git /tmp/aiox-sync && rsync -a /tmp/aiox-sync/squads/seo/ /mnt/d/pncp-poc/squads/aiox-seo/ --exclude='config/smartlic-overlay.yaml' --exclude='*.smartlic.md' --exclude='UPSTREAM.md'`
